...
$GCC -c kernel/keyboard_controller.c -o obj/keyboard_controller.o -std=gnu99 -ffreestanding -Wall -Wextra
$GCC -c kernel/keyboard.c -o obj/keyboard.o -std=gnu99 -ffreestanding -Wall -Wextra
$AS kernel/interrupts.s -o obj/interrupts_s.o
$GCC -c kernel/interrupts.c -o obj/interrupts_c.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra
